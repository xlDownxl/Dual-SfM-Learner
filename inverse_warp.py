...
def inverse_warp2(img, depth, ref_depth, pose, intrinsics, padding_mode='zeros'):
    ...
    #rot=None
    #src_pixel_coords_depth, computed_depth = cam2pixel2(cam_coords, rot, tr, padding_mode)
    #projected_depth = F.grid_sample(ref_depth, src_pixel_coords_depth, padding_mode=padding_mode, align_corners=False)
